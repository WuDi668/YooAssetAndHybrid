...
public class LoadDllUtil : SingletonMono<LoadDllUtil>
{
    ...
    private void LoadHotDll()
    {
        ...
        PackageEventData packageEventData = new PackageEventData();
        packageEventData.Package = YooAssets.GetPackage("DefaultPackage");
        EventBus.Instance.Publish<PackageEventData>(packageEventData);
    }
    #endregion
}